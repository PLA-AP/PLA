...
Below are approximate times for running the experiments based on our hardware configuration (e.g., Intel Xeon Gold 6226 CPU @ 2.70GHz, 16GB RAM), with the simulations run on a single core of the CPU:
